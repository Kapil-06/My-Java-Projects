            ...
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
                ...
                <table id="customers" style="margin-right: 300px">
                    ...
                    <tr>
                        ...
                        <td><a href="Order_OC.jsp?id=<%=rs.getString("id")%>&qn=<%=rs.getString("quantity")%>&price=<%=rs.getString("price")%>&cid=<%=rs.getString("cid")%>" class="btn btn-success btn-lg">Order</a></td>
                    </tr>
                </table>
            </div>
        </section>
