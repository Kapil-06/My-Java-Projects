    ...
    <body>
                        ...
                        <div class="nav_main">
                            <nav>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="Hospital_login.jsp" class="active nav-style">Hospital</a>
                                    </li>
                                    <li>
        ...
        <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
                <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Hospital Register</h3>
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <form action="hospital_reg" method="post">
                            <div class="form-group contact-forms col-lg-12">
                                <label>Name :</label>
                                <input type="text" class="form-control" name="username" placeholder="Enter Hospital Name" required=""><br>
                            </div>
                            <div class="form-group contact-forms col-lg-12">
                                <label>Email :</label>
                                <input type="email" class="form-control" name="email" placeholder="Enter Email ID" required=""><br>
                            </div>
                            <div class="form-group contact-forms col-lg-12">
                                <label>Phone No :</label>
                                <input type="text" class="form-control" name="phone" placeholder="Enter Phone No" required=""><br>
                            </div>
                            <div class="form-group contact-forms col-lg-12">
                                <label>Address :</label>
