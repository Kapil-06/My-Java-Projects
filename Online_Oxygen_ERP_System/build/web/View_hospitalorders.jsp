    ...
    <body>
                        ...
                        <div class="nav_main">
                            <nav>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="View_hospitalorders.jsp" class="active nav-style">View Hospital Orders</a>
                                    </li>
                                    <li>
        ...
        <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
                <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">View Hospital Orders</h3>
                <div class="row">
                    <div class="col-lg-12">
                        <table id="customers" style="margin-right: 300px">
                            ...
                            <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("SELECT * FROM hospital_ordrs WHERE cid ='"+ id +"' ");
                            ...
                            <tr>
                                ...
                                <td><a href="approve_horder.jsp?oid=<%=rs.getString("id")%>" class="btn btn-success btn-lg">Approve</a></td>
                            </tr>
                            <%                                        }
                                } catch (Exception ex) {
                                    ex.printStackTrace();
