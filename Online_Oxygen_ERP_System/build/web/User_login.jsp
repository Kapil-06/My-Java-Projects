    ...
    <body>
        ...
        <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
            <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
                <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">User Login</h3>
                <div class="row">
                    <div class="col-lg-6">
                        <img src="images/ulogin.jpg" width="450" height="200" />
                    </div>
                    <div class="col-lg-6">
                        <form action="user_signin.jsp" method="post">
                            ...
                            <div class="form-group contact-forms col-lg-12">
                                ...
                                <a href="user_signup.jsp" class="btn btn-primary btn-lg">Register!</a>
                            </div>
                        </form>
                    </div>
                </div>
