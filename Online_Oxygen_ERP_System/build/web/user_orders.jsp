                        ...
                        <div class="nav_main">
                            <nav>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="View_oxygens.jsp" class="nav-style">View Oxygen Cylinders</a>
                                    </li>
                                    <li>
                                        <a href="user_orders.jsp" class="active nav-style">Your Orders</a>
                                    </li>
                                    <li>
                    ...
                    <div class="col-lg-12">
                        <table id="customers" style="margin-right: 300px">
                            ...
                            <%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("SELECT * FROM user_ordrs WHERE uid ='"+ id +"' ");
